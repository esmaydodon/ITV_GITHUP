...
//hace algo     
 $(".gestionarMarca").click(function(evento)
      {
          $("#listarMarca").css("display", "block");
          $("#editMarca").css("display", "block");
          $("#formulario-marca-nuevo").css("display", "none");
}); 
//hace algo end 
...
<li><a href="itv.php" >Registrar Itv</a></li>
      ...
      <div id="mainContent">
         <!-- nuevo cliente -->
 <div id="formulario-marca-nuevo" class="contacto">
 <form action="Registrandomarca.php" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this);" >
     nombre_marca :<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="nombre_marca"  id="nombre_marca" bsize="60" maxlength="120" value="" /> <br>
 
 <input type="hidden" name="estado_marca" size="10"  value="1" /> <br/>
     <input type="submit" value="Registrar" />
</form>
    </div>
          <a class="button mediano azul" href="#"><span class="gestionarMarca" onclick="gestionarMarca()">Listar Marcas</span></a>
              <div id="listarMarca" class="oculto"></div>
              <div id="editMarca" class="oculto"></div>
 <!-- nuevo cliente END-->
      <!-- end #mainContent --></div>
