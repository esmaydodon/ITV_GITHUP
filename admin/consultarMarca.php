...
$consulta = dime("select m.*  from marca m where m.estado_marca='1'
        order BY m.idmarca desc LIMIT $RegistrosAEmpezar, $RegistrosAMostrar  ")or 
die(ovni(" .php/consultando marca"));
echo "  <h3>Marcas</h3>
    <div id='myPrintArea'>
...
while($documentos = mysql_fetch_array($consulta)){
	echo "
<tr>
<td>". $documentos['nombre_marca']."</td>
 
     <td>
     <a  style='cursor:pointer; text-decoration:underline;' onclick='eliminarMarca(".$documentos['idmarca'].")'>    <img src='../imagenes/remove.png' width='16' height='16'></a>
	 </td>
    <td> 
     <a  style='cursor:pointer; text-decoration:underline;' onclick='pedirDatosMarca(".$documentos['idmarca']. ")'><img   src='../imagenes/application_edit.png' width='16' height='16'></a> 
	 </td>
     </tr>
	";
	}
	#paginar	
$NroRegistros=mysql_num_rows(mysql_query("SELECT * FROM marca where estado_marca='1'"));
$PagAnt=$PagAct-1;
$PagSig=$PagAct+1;
