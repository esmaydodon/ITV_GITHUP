...
<form name="frmbusqueda2"  onKeyPress="buscarempresa();" class="contacto" >
...
<form name="frmbusqueda3"  onKeyPress="buscarVehiculo();" class="contacto">
    <input type="hidden" value="empresa" name="dedoc" id="dedoc"></input>
    Buscar Vehiculo: 
  <input type="text" name="dato" id="dato"/></form>
 <fieldset>
 ...
 <form action="RegistrandoEmpresa_vehiculo.php" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this);" >
...
if($empresa){
	 foreach($empresa as $k => $d){
             if(!$d || !isset($d[md5($d['idempresa'])]['identificador']) || $d[md5($d['idempresa'])]['identificador']!= md5($d['idempresa'])){ 
$cadenaAgregarQuitar="<a href='borracarempresaSecion.php?SID&id=".$d['idempresa']."&dedo=empresa&eliminaconductor=1'>
<img src='../imagenes/trash.gif' border='0' title='Agregar al Carrito'></a>";	
		}else{
	$cadenaAgregarQuitar="<a  class='ocultar_para_imprimir'  href='agregaempresa.php?SID&id=".$d['idempresa']."&dedo=empresa'>
<img src='../imagenes/productonoagregado.gif' border='0' title='Agregar al Carrito'></a>";
	}
		 
		 echo" <fieldset>razon_social_empresa:".$d['razon_social_empresa']."<br>";  
		 echo" ruc_empresa:".$d['ruc_empresa']."<br>";  
                 echo" direccion_empresa:".$d['direccion_empresa']."<br>";
		 echo"telefono_empresa:".$d['telefono_empresa']."-<br>";
	echo " <input type='hidden' name='idempresa' value='".$d['idempresa']."'></input>";	   
...
$cadenaAgregarQuitar="<a href='borracarVehiculoSecion.php?SID&id=".$d['idvehiculo']."&dedo=empresa&eliminavehiculo=1'>
<img src='../imagenes/trash.gif' border='0' title='Agregar al Carrito'></a>";	
		}else{
	$cadenaAgregarQuitar="<a  class='ocultar_para_imprimir'  href='agregaVehiculo.php?SID&id=".$d['idvehiculo']."&dedo=empresa'>
<img src='../imagenes/productonoagregado.gif' border='0' title='Agregar al Carrito'></a>";
	}
