...
<li><a href="itv.php" >Registrar Itv</a></li>
 ...
 <form action="Registrandoperiodo.php" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this);" >
     Nombre Periodo :<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="descripcion_periodo"  id="descripcion_periodo" bsize="60" maxlength="120" value="" /> <br>
 ...
 <input type="hidden" name="estado_periodo" size="10"  value="1" /> <br/>
