...
//hace algo     
 $(".gestionarEmpresa").click(function(evento)
      {
          $("#listarEmpresas").css("display", "block");
          $("#editEmpresa").css("display", "block");
...
<li><a href="itv.php" >Registrar Itv</a></li>
 ...
 <table>
 <form action="RegistrandoEmpresa.php" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this);" >
     <tr><td align="left">Raz&oacute;n Social</td><td align="right"><spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="razon_social_empresa"  id="razon_social_empresa" bsize="60" maxlength="120" value="" /></td></tr>
         <tr><td align="left">RUC</td><td align="right"><spam class="requerido" >*</spam><input type="text" name="ruc_empresa" size="12" maxlength="120"  onBlur="checkField(this);"  id="ruc_empresa" value="" /> </td></tr>
<tr><td align="left">Direcci&oacute;n</td><td><spam class="requerido" >*</spam><input type="text" name="direccion_empresa" size="60"  value="" /></td></tr>
<tr><td align="left">E-Mail</td><td align="right"><input type="text" name="email_empresa" size="50" maxlength="50" value="" /></td></tr>
<tr><td align="left">Telefono Fijo</td><td align="right"><spam class="requerido" >*</spam><input type="text" name="telefono_empresa" size="15" maxlength="10" value="" /></td></tr>
<tr><td align="left">Telefono M&oacute;vil</td><td align="right"><input type="text" name="movil_empresa" size="15" maxlength="50" value="" /></td></tr> 
 
<tr><td align="left">Sitio Web</td><td align="right"><input type="text" name="web_empresa" size="10" maxlength="20" value="" /></td></tr>
 <input type="hidden" name="estado_empresa" size="10"  value="1" />
     <tr><td><input type="submit" value="Registrar" /></td><td></td></tr>
</form>
</table>
    </div>
              <a class="button mediano azul" href="#"><span class="gestionarEmpresa" onclick="gestionarEmpresas()">Listar Empresas</span></a>
              <div id="listarEmpresas" class="oculto"></div>
              <div id="editEmpresa" class="oculto"></div>
