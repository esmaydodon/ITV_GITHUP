...
<li><a href="itv.php" >Registrar Itv</a></li>
 ...
 <form action="RegistrandoLugar.php" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this);" >
     Nombre Lugar :<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="descripcion_lugar_inspeccion"  id="descripcion_lugar_inspeccion" bsize="60" maxlength="120" value="" /> <br>

         
 
 <input type="hidden" name="estado_lugar" size="10"  value="1" /> <br/>
