...
//hace algo     
 $(".gestionarTipo").click(function(evento)
      {
          $("#listarTipo").css("display", "block");
          $("#editTipo").css("display", "block");
          $("#formulario-tipo-nuevo").css("display", "none");
}); 
//hace algo end 
...
<li><a href="itv.php" >Registrar Itv</a></li>
      ...
      <div id="mainContent">
         <!-- nuevo cliente -->
 <div id="formulario-tipo-nuevo" class="contacto">
 <form action="Registrandotipo.php" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this);" >
     nombre_tipo :<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="nombre_tipo"  id="nombre_tipo" bsize="60" maxlength="120" value="" /> <br>
<input type="hidden" name="estado_tipo" size="10"  value="1" /> <br/>
     ...
     <input type="submit" value="Registrar" />
         ...
         <a class="button mediano azul" href="#">
             <span class="gestionarTipo" onclick="gestionarTipo()">Listar Tipos</span></a>
              <div id="listarTipo" class="oculto"></div>
              <div id="editTipo" class="oculto"></div>
 <!-- nuevo cliente END-->
      <!-- end #mainContent --></div>
