...
<li><a href="itv.php" >Registrar Itv</a></li>
      ...
      <div id="mainContent">
         <!-- nuevo cliente -->
 <div id="formulario-tecnico-nuevo" class="contacto">
 <form action="Registrandotecnico.php" method="post" enctype="multipart/form-data" onSubmit="return checkForm(this);" >
     descripcion_tecnico:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="descripcion_tecnico"  id="descripcion_tecnico" bsize="60" maxlength="120" value="" /> <br>
          <input type="hidden" name="estado_tecnico"  id="estado_tecnico" bsize="60" maxlength="120" value="1" /> <br>
     ap_pat__tecnico:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="ap_pat__tecnico"  id="ap_pat__tecnico" bsize="60" maxlength="120" value="" /> <br>
     ap_mat__tecnico:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="ap_mat__tecnico"  id="ap_mat__tecnico" bsize="60" maxlength="120" value="" /> <br>
     direccion_tecnico:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="direccion_tecnico"  id="direccion_tecnico" bsize="60" maxlength="120" value="" /> <br>
     email_tecnico:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="email_tecnico"  id="email_tecnico" bsize="60" maxlength="120" value="" /> <br>
     telefono_tecnico:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="telefono_tecnico"  id="telefono_tecnico" bsize="60" maxlength="120" value="" /> <br>
     movil_tecnico:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="movil_tecnico"  id="movil_tecnico" bsize="60" maxlength="120" value="" /> <br>
<!--Fecha Inicio:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="fini" class="campofecha" id="fini" bsize="60" maxlength="120" value="" /> <br>
    Fecha Fin:<spam class="requerido" >*</spam><input type="text" onBlur="checkField(this);" name="ffin" class="campofecha" id="ffin" bsize="60" maxlength="120" value="" /> <br>-->
 
 <input type="hidden" name="estado_tecnico" size="10"  value="1" /> <br/>
